# Données de démonstration de la variante dart-sass. Le texte diffère de celui
...
[
  {
    title: "Bienvenue dans railsbox (dart-sass)",
    body: "Le style de cette page a été compilé par le binaire dart-sass, qui " \
  ...
  },
  {
    ...
    body: "Uniquement le résultat : public/assets et app/assets/builds. Le binaire " \
          "reste sur l'hôte de construction, et la gem dart-sass-ruby installée " \
  ...
  },
  {
    ...
    body: "La feuille servie contient un utilitaire à valeur arbitraire, " \
          "tracking-[0.35em], qu'aucune feuille dart-sass pré-construite ne peut " \
...
puts "Seed dart-sass terminé : #{Post.count} billets."
